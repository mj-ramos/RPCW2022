            ...
            <div class="w3-display-container" style="padding-bottom:3%">
                ...
                <div class="w3-row ">
                    ...
                    <div class="w3-col l2 m6 s6">
                        <button class="w3-button w3-round-xlarge w3-orange" onclick="document.getElementById('edit${t.id}').style.display='block'">Editar</button>
                    </div>   
...
function editarCard(t) {
    return `
        <div id="edit${t.id}" class="w3-card w3-margin w3-padding-16 w3-orange w3-display-container" style="display:none">
            ...
            <form class="w3-margin-top" action="/tarefas/${t.id}/editar" method="POST">  
                    <div class="w3-container w3-padding-16 w3-sand" style="text-align: left;">
                        ...
                        <input class="w3-input  w3-margin-bottom w3-light-grey w3-animate-input" style="width:40%" type="date" name="deadline" value="${t.deadline}">
